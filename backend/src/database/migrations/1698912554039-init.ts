...
export class Init1698912554039 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "prestige" ("createdAt" TIMESTAMP NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "image" character varying NOT NULL, "name" character varying NOT NULL, "price" character varying NOT NULL, "moneyMult" character varying NOT NULL, CONSTRAINT "UQ_efe4daf7e3e9773f02a6d8008be" UNIQUE ("name"), CONSTRAINT "PK_b2fb44ff74d75fa9274d2d5bb17" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "prestigeBought" ("createdAt" TIMESTAMP NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "prestigeId" uuid, "userId" uuid, CONSTRAINT "PK_47113c8db339ed17f6e3948ad5f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "item" ("createdAt" TIMESTAMP NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "image" character varying NOT NULL, "name" character varying NOT NULL, "price" character varying NOT NULL, "moneyPerSecond" character varying NOT NULL, "moneyPerClickMult" character varying NOT NULL, CONSTRAINT "UQ_c6ae12601fed4e2ee5019544ddf" UNIQUE ("name"), CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "itemBought" ("createdAt" TIMESTAMP NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "itemId" uuid, "userId" uuid, CONSTRAINT "PK_9f79e71ede98758308cb65be9ba" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
